...
/mob/living/proc/makeTrail(turf/target_turf, turf/start, direction)
	...
	for(var/obj/effect/decal/cleanable/blood/trail_holder/trail in start)
		...
		trail.add_overlay(image(colored_blood_icon('icons/effects/blood.dmi'), trail_type, dir = newdir)) // SPLURT EDIT - Colored Blood
		trail.transfer_mob_blood_dna(src)
		trail.color = trail.blood_DNA_to_color(trail.color) // SPLURT ADDITION - Colored Blood
