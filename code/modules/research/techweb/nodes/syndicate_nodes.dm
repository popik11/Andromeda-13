/datum/techweb_node/syndicate_basic
	...
	description = "Опасные исследования, используемые для создания опасных объектов."
...
/datum/techweb_node/unregulated_bluespace
	...
	display_name = "Нерегулируемое Исследование Блюспейс"
	description = "Технология блюспейса, использующая нестабильные или несбалансированные процедуры, способные повредить ткань блюспейса. Запрещены галактическими конвенциями."
