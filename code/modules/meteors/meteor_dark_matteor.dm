...
/obj/effect/meteor/dark_matteor/moved_off_z()
	...
	priority_announce("Ого. Темный Мэтт-Ор действительно пропустил вашу станцию. Не забудьте поблагодарить своего священника за его очевидное божественное вмешательство.", "Обновление о метеоре")
