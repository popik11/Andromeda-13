...
/proc/send_pirate_threat(list/pirate_selection)
	...
	//send message
	priority_announce("Incoming subspace communication. Secure channel opened at all communication consoles.", "Входящее сообщение", SSstation.announcer.get_rand_report_sound())
