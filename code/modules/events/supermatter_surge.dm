...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("Система контроля целостности кристаллов обнаружила необычные свойства атмосферы в камере суперматерии, выход энергии из кристалла суперматерии значительно увеличился. Требуется инженерное вмешательство для стабилизации работы кристала.", "Оповещение о [class_to_announce] уровне всплеска Суперматерии", SSstation.announcer.event_sounds[ANNOUNCER_SUPERMATTER_SURGE] || 'sound/machines/engine_alert/engine_alert3.ogg') // SPLURT EDIT - ORIGINAL: priority_announce("The Crystal Integrity Monitoring System has detected unusual atmospheric properties in the supermatter chamber, energy output from the supermatter crystal has increased significantly. Engineering intervention is required to stabilize the engine.", "Class [class_to_announce] Supermatter Surge Alert", 'sound/machines/engine_alert/engine_alert3.ogg')
...
/datum/round_event/supermatter_surge/end()
	...
	priority_announce("Всплеск суперматерии рассеялся, показания выходного сигнала кристалла нормализовались.", "Аномалия устранена")
	engine = null
	sm_gas = null
...
/datum/round_event/supermatter_surge/poly/announce(fake)
	priority_announce("Система контроля целостности кристаллов обнаружила необычный резонанс типа «попугай» в камере суперматерии, выход энергии из кристалла суперматерии значительно увеличился. Требуется инженерное вмешательство для стабилизации работы.", "Оповещение о P уровне всплеска Суперматерии", 'sound/machines/engine_alert/engine_alert3.ogg')
