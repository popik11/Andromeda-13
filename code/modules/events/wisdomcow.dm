...
/datum/round_event/wisdomcow/announce(fake)
	priority_announce("В окрестностях была замечена мудрая корова. Не забудьте спросить у нее совета.", "Агентство по разведению коров", ANNOUNCER_WISDOM_COW) // SPLURT EDIT - ORIGINAL: priority_announce("A wise cow has been spotted in the area. Be sure to ask for her advice.", "Nanotrasen Cow Ranching Agency")
