...
/datum/round_event/wisdomcow/announce(fake)
	priority_announce("A wise cow has been spotted in the area. Be sure to ask for her advice.", "Агентство по разведению коров", ANNOUNCER_WISDOM_COW) // SPLURT EDIT - ORIGINAL: priority_announce("A wise cow has been spotted in the area. Be sure to ask for her advice.", "Nanotrasen Cow Ranching Agency")
