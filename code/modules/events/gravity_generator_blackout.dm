...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("В районе [station_name()]. обнаружены гравитосферные аномалии. Требуется ручной сброс генераторов.", "Предупреждение об аномалии", ANNOUNCER_GRANOMALIES)
