...
/datum/round_event/anomaly/anomaly_grav/announce(fake)
	...
	priority_announce("Gravitational anomaly detected on [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Предупреждение об аномалии" , ANNOUNCER_GRAVANOMALIES) //SKYRAT EDIT CHANGE - ORIGINAL: priority_announce("Gravitational anomaly detected on [ANOMALY_ANNOUNCE_HARMFUL_TEXT] [impact_area.name].", "Предупреждение об аномалии" , ANNOUNCER_GRANOMALIES)
