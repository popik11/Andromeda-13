...
/datum/round_event/grey_tide/announce(fake)
	if(fake)
		severity = rand(1,3)
	priority_announce("Вирус Gr3y.T1d3 обнаружен в подпрограммах шифрования безопасной блокировки [station_name()]. Уровень угрозы [severity]. Рекомендуется участие ИИ станции.", "Оповещение о безопасности")
