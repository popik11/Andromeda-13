...
/datum/round_event/dark_matteor/announce(fake)
	priority_announce("Тревога. Помехи в работе метеоритных спутников привлекли темный маттериор. Объект стремительно приближается к [GLOB.station_name]. Приготовьтесь к столкновению", "Метеоры", 'sound/announcer/alarm/delta.ogg')
