...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("На борту [station_name()]. обнаружено агрессивность брендового интеллекта. Пожалуйста, проверьте всех поставщиков брендов [machine_name] на предмет агрессивной маркетинговой тактики и при необходимости перезагрузите их.", "Оповещение о машинном обучении", ANNOUNCER_BRANDINTELLIGENCE) //SKYRAT EDIT CHANGE - ORIGINAL: priority_announce("Rampant brand intelligence has been detected aboard [station_name()]. Please inspect any [machine_name] brand vendors for aggressive marketing tactics, and reboot them if necessary.", "Machine Learning Alert")
