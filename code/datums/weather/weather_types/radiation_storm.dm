...
/datum/weather/rad_storm/end()
	if(..())
		return
	priority_announce("The radiation threat has passed. Please return to your workplaces.", "Предупреждение об аномалии", ANNOUNCER_RADIATIONPASSED) //SKYRAT EDIT CHANGE
	status_alarm(FALSE)
