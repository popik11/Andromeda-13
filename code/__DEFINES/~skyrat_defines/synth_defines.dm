...
/// Mechfab defines
#define RND_SUBCATEGORY_MECHFAB_ANDROID "/Андроид"
#define RND_SUBCATEGORY_MECHFAB_ANDROID_CHASSIS "/Корпауса Андроидов"
#define RND_SUBCATEGORY_MECHFAB_ANDROID_ORGANS "/Органы Андроидов"
