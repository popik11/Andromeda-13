...
#define ANOMALY_ANNOUNCE_MEDIUM_TEXT "сканерах дальнего действиях. Предполагаемое местоположение:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_HARMFUL_TEXT "локализованных сканерах. Местоположение обноружения:"
...
///Let them know how far away the anomaly is
#define ANOMALY_ANNOUNCE_DANGEROUS_TEXT "локализованных сканерах. Местоположение обноружения:"
