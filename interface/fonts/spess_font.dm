...
/datum/font/spessfont
	name = "Spess Font"
	font_family = 'interface/fonts/SpessFontRus.ttf' /// ADD ANDROMEDA-13 (@Rewokin): Cyrillic - наше слонярское: 'interface/fonts/SpessFont.ttf' -> 'interface/fonts/SpessFontRus.ttf'
