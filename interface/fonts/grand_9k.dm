...
/datum/font/grand9k
	name = "Grand9K Pixel"
	font_family = 'interface/fonts/Grand9K_Pixel_Rus.ttf' /// ADD ANDROMEDA-13 (@Rewokin): Cyrillic - наше слонярское: 'interface/fonts/Grand9K_Pixel.ttf' -> 'interface/fonts/Grand9K_Pixel_Rus.ttf'
