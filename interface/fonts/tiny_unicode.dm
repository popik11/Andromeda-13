...
/datum/font/tiny_unicode
	name = "TinyUnicode"
	font_family = 'interface/fonts/TinyUnicodeRus.ttf' /// ADD ANDROMEDA-13 (@Rewokin): Cyrillic - наше слонярское: 'interface/fonts/TinyUnicode.ttf' -> 'interface/fonts/TinyUnicodeRus.ttf'
