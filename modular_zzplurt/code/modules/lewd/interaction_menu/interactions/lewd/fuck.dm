/datum/interaction/lewd/fuck	/// ADD ANDROMEDA-13 (@Мисс Кира): Перевод, дополнение ЕРП контента.
	...
	cum_message_text_overrides = list(
		CLIMAX_POSITION_USER = list(
			"A Кончает глубоко внутрь киски %TARGET%!",
			"A Вжавшись в выпаде, наполняет киску %TARGET%!",
			"A Прижавшись и войдя как можно глубже, наполняет %TARGET%!",
			"A Шлепаясь яйцами, стреляет глубоко во внутрь %TARGET% переполняя вагину!",
			"A Выстреливает семенем прямо во внутрь %TARGET%!",
			"A Покрывает все пространство внутри %TARGET% своим семенем!"
		),
		CLIMAX_POSITION_TARGET = list(
			"A Оргазмирует прямо на член и таз %USER%!",
			"A Вздрагивая и выгинаясь, сквиртует на %USER%!",
			"A Выгинаясь от удовольствия, обильно сквиртует на таз и член %USER%!",
			"A Выстреливает сладкими соками прямо на %USER%!",
			"A Покрывает сладкими соками таз %USER%!"
		)
	)
	cum_self_text_overrides = list(
		CLIMAX_POSITION_USER = list(
			"A Вы кончаете глубоко во внутрь киски %TARGET% ощущая свой долг исполненным!",
			"A Вы вжимаетесь в выпаде, наполняя одним обильным выстрелом киску %TARGET%!",
			"A Вы прижимаетесь как можно сильнее и войдя как можно поглубже, наполняете пизденку %TARGET%!",
			"A Шлепнувшись яйцами, вы выстреливаете в киску %TARGET% нереполняя её теплом!",
			"A Вы стреляете семенем прямо во внутрь %TARGET% переполняя внутренности вагины!",
			"A Вы покрываете семенем внутренности киски %TARGET%!"
		),
		CLIMAX_POSITION_TARGET = list(
			"A Вы сквиртуете на член %USER%!",
			"A Вы стреляете своими соками на таз и член %USER%!",
			"A Вздрагивая и выгинаясь, вы сквиртуете на %USER%!",
			"A Выгинаясь от удовольствия, вы обильно сквиртуете на %USER%!",
			"A Вы покрываете своими соками пенис %USER% сквиртуя!"
		)
	)
	cum_partner_text_overrides = list(
		CLIMAX_POSITION_USER = list(
			"A %USER% Кончает глубоко внутрь вас, это очень тепло и приятно!",
			"A %USER% Вжимается в вас молниеносным ударом глубоко во внутрь, тут же наполняя вас обильным выстрелом во-внутрь!",
			"A %USER% Прижимается к вам как можно сильнее, и войдя поглубже начинает расстреливать вашу пизденку изнутри!",
			"A %USER% Шлепаясь об вас яйцами, молниеносно стреляет внутрь вас семенем, переполняя вас!",
			"A %USER% Стреляет семенем прямо в вашу пизденку, вы ощущаете наполненность!",
			"A %USER% Покрывает семенем ваши внутренности киски!"
		),
		CLIMAX_POSITION_TARGET = list(
			"A %TARGET% Сквиртует на ваш член и таз!",
			"A %TARGET% Вздрагивая и выгинаясь, сквиртует прямо на вас!",
			"A %TARGET% Выгинаясь от удовольствия, обильно стреляет сквиртом на вас!",
			"A %TARGET% Стреляет своими соками прямо на вас!",
			"A %TARGET% Пачкает вас своими сладкими соками!"
		)
	)
	message = list(
