...
/datum/round_event/wizard_dice/announce(fake)
	if(prob(80)) //Announcement Optimization
		priority_announce("В этом районе был обнаружен магический Многогранный артефакт. Пожалуйста, воздержитесь от взаимодействия с тем, что не может быть объяснено наукой.", "Предупреждение Эксперта Магасолога")
